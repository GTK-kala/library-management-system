...
const Books = () => {
  ...
  }, [filteredBooks, startIndex]);

  // Memoize max visible pages based on window width
  const maxVisiblePages = useMemo(() => {
    return windowWidth < 640 ? 3 : 5;
  }, [windowWidth]);
    ...
    return ({ book }) => (
      ...
      >
        ...
        <div className="px-4 pb-4 sm:px-6 sm:pb-6">
          ...
          >
            {book.is_available ? "Borrow Now" : "Unavailable"}
          </button>
        </div>
      </motion.div>
    );
        ...
        <div className="pt-4 mt-6 border-t border-gray-200 sm:mt-8 sm:pt-6 dark:border-gray-800">
          <div className="flex flex-wrap justify-center gap-4 text-xs text-gray-500 sm:text-sm dark:text-gray-400">
            <div className="flex items-center">
              ...
              <span>
                {books.filter((b) => b.is_available).length} Available
              </span>
            </div>
            <div className="flex items-center">
